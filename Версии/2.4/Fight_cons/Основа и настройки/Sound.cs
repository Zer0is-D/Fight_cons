...
namespace Fight_cons
{
    class Sound
    {
        public static async void Music_player()
        {
            await Task.Run(() => LongFanfares_Play());
        }
        ...
        ////dependig of method IsPoint converts a string to a float 
        //public static float ParseStringToSingle(String Value)
        //{
        //    if (Value.Length < 1)
        //        return 0;
        //    if (IsPoint())
        //        return float.Parse(Value = Value.Replace(",", "."), System.Globalization.NumberStyles.Float);
        //    else
        //        return float.Parse(Value = Value.Replace(".", ","), System.Globalization.NumberStyles.Float);
        //}

        ////gets if system setting for decimal places is . or ,
        //public static bool IsPoint()
        //{
        //    string validation = Convert.ToString(0.5);
