...
{
    internal class Ally : Unit
    {
        internal Ally(string name, sbyte phase, int hp, int attack, int speed, 
            int crit_chance, int defence, int magic_defence, int block,
        ...
        //  Конструктор 2       
        public Ally(string name, sbyte phase, int HP_min, int HP_max,
