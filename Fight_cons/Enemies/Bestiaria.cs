    ...
    public class Bestiaries : Charecter
    {
        ...
        public static void CreateBasicBestiary()
        {
            List<Bestiaries> bestiaries = new List<Bestiaries>
            {
                //  Пещерные противники
                /*0*/
                new Bestiaries("Нечто Неизведанное", phase: 0, hpMin: 5, hpMax: 15, attMin: 1, attMax: 3, spdMin: 30, spdMax: 40, critMin: 5, critMax: 10, defMin: 0, defMax: 0, mDefMin: 0, mDefMax: 0, blkMin: 10, blkMax: 30, movMin: 2, movMax: 3, role: ChaRole.Enemy, strategy: Strategeis.Any) { Id = 0 },
                /*1*/
                new Bestiaries("Нечто Бронированное", phase: 0, hpMin: 5, hpMax: 15, attMin: 1, attMax: 2, spdMin: 30, spdMax: 40, critMin: 5, critMax: 10, defMin: 20, defMax: 70, mDefMin: 0, mDefMax: 0, blkMin: 10, blkMax: 30, movMin: 1, movMax: 2, role: ChaRole.Enemy, strategy: Strategeis.Any) { Id = 1 },
                /*2*/
                new Bestiaries("Нечто Магическое", phase: 0, hpMin: 5, hpMax: 15, attMin: 1, attMax: 2, spdMin: 30, spdMax: 45, critMin: 5, critMax: 10, defMin: 0, defMax: 0, mDefMin: 30, mDefMax: 70, blkMin: 10, blkMax: 30, movMin: 2, movMax: 3, role: ChaRole.Enemy, strategy: Strategeis.Any) { Id = 2 },

                //  Противники в долине
                /*3*/
                new Bestiaries("Зверь", phase: 0, hpMin: 10, hpMax: 20, attMin: 1, attMax: 5, spdMin: 30, spdMax: 30, critMin: 1, critMax: 2, defMin: 0, defMax: 0, mDefMin: 0, mDefMax: 0, blkMin: 20, blkMax: 40, movMin: 1, movMax: 2, role: ChaRole.Wild, strategy: Strategeis.Agresive) { Id = 3 },

                //  Противники в лесу
                /*4*/
                new Bestiaries("Демон", phase: 0, hpMin: 15, hpMax: 30, attMin: 3, attMax: 5, spdMin: 30, spdMax: 30, critMin: 10, critMax: 15, defMin: 0, defMax: 0, mDefMin: 20, mDefMax: 30, blkMin: 1, blkMax: 5, movMin: 2, movMax: 5, role: ChaRole.Enemy, strategy: Strategeis.Any) { Id = 4 },
                ...
                /*8*/
                new Bestiaries("Камень", phase: 0, hp: 6, attack: 0, speed: 0, critChance: 0, defence: 0, magicDefence: 0, block: 0, moves: 2, noRun: true, ChaRole.Enemy) { Id = 8 },
                /*9*/
                new Bestiaries("Некромант", phase: 0, hp: 20, attack: 0, speed: 20, critChance: 0, defence: 0, magicDefence: 30, block: 0, moves: 5, noRun: true, ChaRole.Enemy, strategy: Strategeis.Necromancer) { Id = 9 },
                /*10*/
                ...
                //  Союзники после 99
                /*100*/
                new Bestiaries("Доброе Неизведанное", phase: 0, hpMin: 5, hpMax: 15, attMin: 1, attMax: 3, spdMin: 30, spdMax: 30, critMin: 5, critMax: 10, defMin: 0, defMax: 0, mDefMin: 0, mDefMax: 0, blkMin: 10, blkMax: 30, movMin: 2, movMax: 3, role: ChaRole.Ally, strategy: Strategeis.Any) { Id = 100 },
                /*101*/
                new Bestiaries("Доброе Бронированное", phase: 0, hpMin: 5, hpMax: 15, attMin: 1, attMax: 2, spdMin: 30, spdMax: 30, critMin: 5, critMax: 10, defMin: 20, defMax: 70, mDefMin: 0, mDefMax: 0, blkMin: 10, blkMax: 30, movMin: 1, movMax: 2, role: ChaRole.Ally, strategy: Strategeis.Any) { Id = 101 },
                /*102*/
                new Bestiaries("Доброе Магическое", phase: 0, hpMin: 5, hpMax: 15, attMin: 1, attMax: 2, spdMin: 30, spdMax: 30, critMin: 5, critMax: 10, defMin: 0, defMax: 0, mDefMin: 30, mDefMax: 70, blkMin: 10, blkMax: 30, movMin: 2, movMax: 3, role: ChaRole.Ally, strategy: Strategeis.Any) { Id = 102 },
            };
